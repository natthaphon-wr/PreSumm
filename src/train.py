...
from train_extractive import train_ext, validate_ext, test_ext, lambda_tuned_ext, test_text_ext
...
if __name__ == '__main__':
    ...
    parser.add_argument("-mode", default='train', type=str, choices=['train', 'validate', 'test', 'lambda_tuned', 'test_text'])
